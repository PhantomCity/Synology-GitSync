...
## TODO
- [ ] [Не работает верификация X_HUB_SIGNATURE](PhantomCity/Synology-GitSync#2) так ни один пример и не заработал
- [ ] [Сломалось бекапирование](PhantomCity/Synology-GitSync#1) пока добавлял пораметр ['Backup'], сломалось :( 
